...
assistants, published as a [Quarto](https://quarto.org/) website. Built from
the [UCD-SERG `qwt` (Quarto Website Template)](https://github.com/UCD-SERG/qwt);
the sections below document the template features this repository inherited.
